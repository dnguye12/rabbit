...
void Menu::MainMenu()
{
    ...
    text1.setPosition(20, TAILLEGRILLE * cell_size);

    text2.setFont(font);
    text2.setString(str);
    text2.setCharacterSize(12);
    text2.setPosition(TAILLEGRILLE * cell_size - 200, TAILLEGRILLE * cell_size);

    text3.setFont(font);
    text3.setString(str1);
    text3.setCharacterSize(12);
    text3.setPosition(TAILLEGRILLE * cell_size - 200, TAILLEGRILLE * cell_size + 12);

    text4.setFont(font);
    text4.setString(str2);
    text4.setCharacterSize(12);
    text4.setPosition(TAILLEGRILLE * cell_size - 200, TAILLEGRILLE * cell_size + 24);





    RenderWindow window(VideoMode(TAILLEGRILLE * cell_size,TAILLEGRILLE * cell_size + 220), "Main Menu");
            ...
            case Event::KeyReleased:
                ...
                case Keyboard::Return:
                    ...
                    case 0:
                    {
                        ...
                        sf::RenderWindow window1(sf::VideoMode(TAILLEGRILLE * cell_size, TAILLEGRILLE * cell_size + 220), "Simulation Display");
